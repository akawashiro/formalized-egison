...
\begin{figure}
    ...
    \infrule{}{\G \V s:\tstr \Rightarrow \G}{\textsc{T-Str}} \andalso \\[4mm]
    ...
    \infrule{\G\V M_1:T_1 \Rightarrow \G \andalso \G\V M_2:\tmatcher{T_1} \Rightarrow \G  \\ \G\V p:\tpat{T_1} \Rightarrow \G' \andalso \G' \V M_3:T_3 \Rightarrow \G'}{\G\V\ematchall{M_1\ M_2\ \etup{p\ M_3}}:\tcol{T_3} \Rightarrow \G}{\textsc{T-MatchAll}} \\[4mm]
    ...
    \infrule{}{\G\V \bt{\$}x:\tpat{T} \Rightarrow \G \doubleplus \{ x:T\}}{\textsc{T-PatternVariable}} \\[4mm]
    ...
    \end{center}
    \caption{Type system of our language}
